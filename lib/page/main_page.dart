...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    tooltipBehavior = TooltipBehavior(enable: true, header: 'Bitcoin');
            ...
            child: Center(
              child: StreamBuilder(
                ...
                builder:
                  ...
                  if (snapshot.hasData) {
                    chartData.add(bitcoinFromJson(snapshot.data));
                  }
                    ...
                    children: [
                      SfCartesianChart(
                          ...
                          primaryYAxis: NumericAxis(
                              ...
                              minimum: chartData.length > 2
                                  ? (chartData[1].data!.price! - 300.0)
                                  : 47000,
                              maximum: chartData.length > 2
                                  ? (chartData[1].data!.price! + 300.0)
                                  : 48000),
                      ...
                      if (chartData.length > 1)
                        GridView.builder(
                          itemBuilder: (context, index) {
                            return liveTrade(bitcoin: chartData[index]);
                          },
